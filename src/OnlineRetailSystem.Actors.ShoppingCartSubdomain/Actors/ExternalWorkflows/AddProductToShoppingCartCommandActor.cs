// <copyright file="AddProductToShoppingCartCommandActor.cs" company="Konstantin Siegl">
...
{
    [StatelessWorker]
    internal class AddProductToShoppingCartCommandActor : Grain, IAddProductToShoppingCartCommandActor
    {
        public async Task<CommandResponse> Execute(string shoppingCartId, string productId, int quantity)
        {
            ...
            var result = await cart.AddProduct(productId, quantity);
